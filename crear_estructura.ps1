...
ni lib\features\flujo_visita\presentacion\paginas\datos_proveedor_mineral_pagina.dart, lib\features\flujo_visita\presentacion\paginas\resumen_page.dart -ItemType File -Force
